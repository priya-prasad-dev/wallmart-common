...
var H = function(e3) {
  ...
  r3.setAttribute(A, "active"), r3.setAttribute("data-styled-version", "5.3.6");
  var i3 = q();
...
function Ne(e3, n2, r3, o2) {
  ...
  return e3 instanceof ve ? r3 ? (e3.inject(r3, o2), e3.getName(o2)) : e3 : S(e3) ? function e4(t3, n3) {
    var r4, o3, s4 = [];
    for (var i4 in t3)
      t3.hasOwnProperty(i4) && !_e(t3[i4]) && (Array.isArray(t3[i4]) && t3[i4].isCss || b(t3[i4]) ? s4.push(be(i4) + ":", t3[i4], ";") : S(t3[i4]) ? s4.push.apply(s4, e4(t3[i4], i4)) : s4.push(be(i4) + ": " + (r4 = i4, null == (o3 = t3[i4]) || "boolean" == typeof o3 || "" === o3 ? "" : "number" != typeof o3 || 0 === o3 || r4 in unitless_browser_esm_default ? String(o3).trim() : o3 + "px") + ";"));
...
function qe(e3, t3, n2) {
  ...
  var C2, I3 = new se(n2, g3, o2 ? e3.componentStyle : void 0), P3 = I3.isStatic && 0 === c3.length, O2 = function(e4, t4) {
    return function(e5, t5, n3, r3) {
      ...
      for (var I4 in A4)
        "$" !== I4[0] && "as" !== I4 && ("forwardedAs" === I4 ? C3.as = A4[I4] : (d4 ? d4(I4, emotion_is_prop_valid_esm_default, _3) : !N3 || emotion_is_prop_valid_esm_default(I4)) && (C3[I4] = A4[I4]));
...
var Je = function() {
  function e3() {
    ...
    this._emitSheetCSS = function() {
      ...
      if (e4.sealed)
        return j(2);
      var n2 = ((t4 = {})[A] = "", t4["data-styled-version"] = "5.3.6", t4.dangerouslySetInnerHTML = { __html: e4.instance.toString() }, t4), o2 = q();
